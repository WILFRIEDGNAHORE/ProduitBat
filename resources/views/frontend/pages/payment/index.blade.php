                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <div class="w-[180px]">
                            <a href="{{ route('user.payment.momo') }}">
                                <img src="{{ asset('frontend/assets/images/payment-gateway/MTN_MOMO.jpeg') }}"
                                    class="w-full">
                            </a>
                        </div>

                        <div class="w-[180px]">
                            <a href="{{ route('user.payment.genius') }}">
                                <img src="{{ asset('frontend/assets/images/payment-gateway/geniuspay.png') }}"
                                    class="w-full rounded-xl border border-gray-200 hover:shadow-md transition">
                            </a>
                        </div>
                                ...
                                <div>
                                    <div class="flex flex-col gap-y-4 pb-4 border-b border-gray-300">
                                        <p class="flex items-center justify-between">
                                            Sub-Total<span
                                                class="text-gray-900">{{ $settings->currency_icon }}{{ getSubTotal() }}</span>
                                        </p>
                                        <p class="flex items-center justify-between">
                                            Discount<span class="text-gray-900">(-)
                                                {{ $settings->currency_icon }}{{ discount() }}</span>
                                        </p>
                                        <p class="flex items-center justify-between">
                                            Shipping Fee<span class="text-gray-900">(+)
                                                {{ $settings->currency_icon }}{{ shippingFee() }}</span>
                                        </p>
                                    </div>
                                    <h6 class="flex items-center justify-between text-light-primary-text pt-4">
                                        Total<span
                                            class="text-gray-900">{{ $settings->currency_icon }}{{ finalCost() }}</span>
                                    </h6>
                                </div>
                            </div>
                        </div>
