        ...
        <section class="py-10 bg-white border-b border-gray-200">
            <div class="container">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-y-6">
                    ...
                    <div class="sellzy-countdown flex items-center gap-x-3"
                        data-countdown-date="{{ $flashSaleDate->end_date }}">
                        <div
                            class="flex flex-col items-center justify-center w-[80px] h-[76px] bg-primary-lighter rounded-xl text-center">
                    ...
                    @foreach ($flashSaleItems as $item)
                        @php
                            ...
                            $discountPct = $hasDiscount
                                ...
                                : 0;
                        @endphp
                        <div class="rounded-2xl product-card-1 p-4 group bg-white wow animate__animated animate__fadeInUp"
                            data-wow-delay=".1s">
                                ...
                                @section('content')
                                    ...
                                    @if ($flashSaleDate)
                                        <section class="py-10 bg-white border-b border-gray-200">
                                            <div class="container">
                                                <div
                                                    class="flex flex-col md:flex-row md:items-center md:justify-between gap-y-6">
                                                    <div>
                                                        <h5 class="text-primary font-semibold mb-1">Limited Time Offer</h5>
                                                        <h2 class="text-2xl font-bold font-dm-sans">Hot Deals — Ends Soon</h2>
                                                    </div>
                        ...
                        --}}
                                                            ...
                                                            <div class="product-content">
                                                                @if ($product->category)
                                                                    <p
                                                                        class="text-sm leading-[22px] mb-2 text-light-secondary-text">
                                                                        {{ $product->category->name }}
                                                                    </p>
                                                                @endif

                                                                <h5
                                                                    class="text-sm leading-6 font-semibold font-dm-sans mb-3 line-clamp-2">
                                                                    {{-- TODO: route('frontend.product.show', $product->slug) --}}
                                                                    <a href="{{ route('product-details.show', $item->product->id) }}"
                                                                        class="hover:text-primary transition-colors">{{ $product->name }}</a>
                                                                </h5>
                        ...
                        --}}
                                                                ...
                                                                <div
                                                                    class="price-section flex items-center gap-x-2 flex-wrap mb-3">
                                                                    <span
                                                                        class="current-price text-base font-bold text-light-primary-text">
                                                                        {{ number_format($displayPrice, 2) }}
                                                                        {{ @$settings->currency_icon }}
                                                                    </span>
                                                                    @if ($hasDiscount)
                                                                        <span
                                                                            class="old-price text-sm font-normal text-light-disabled-text line-through">
                                                                ...
                                                                <form class="shopping_cart_form">
                                                                    ...
                                                                    <button type="submit"
                                                                        ...
                                                                        <i
                                                                            class="hgi hgi-stroke hgi-shopping-cart-02 text-white"></i>
                                            ...
                                            @else
                                                <div class="text-center py-20">
                                                    <i
                                                        class="hgi hgi-stroke hgi-sale-tag-02 text-6xl text-gray-300 mb-4 block"></i>
                                                    <h3 class="text-xl font-semibold text-light-secondary-text mb-2">Aucune
                                                        promotion en cours</h3>
                                                    <p class="text-light-disabled-text">Revenez bientôt pour découvrir nos
                                                        offres flash.</p>
                                                    <a href="{{ url('/') }}"
                                                        class="btn btn-primary rounded-full px-8 py-3 mt-6 inline-block">
                                                        Retour à l'accueil
                                                    </a>
                                                </div>
                                            @endif
