                  ...
                  <ul class="navbar-nav" id="navbar-nav">
                      ...
                      <li class="nav-item">
                          ...
                          <div class="collapse" id="sidebarProducts">
                              <ul class="nav sub-navbar-nav">
                                  ...
                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link" href="{{ route('admin.vendor-product.index') }}">Vendor
                                          Products</a>
                                  </li>
                                  <li class="sub-nav-item">
                      ...
                      <li class="nav-item">
                          ...
                          <div class="collapse" id="sidebarSlider">
                              <ul class="nav sub-navbar-nav">
                                  ...
                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link" href="{{ route('admin.flash-sale.index') }}">Manage Flash
                                          Sale</a>
                                  </li>
                              </ul>
                          </div>
                      ...
                      <li class="nav-item">
                          ...
                          <div class="collapse" id="sidebarCategory">
                              <ul class="nav sub-navbar-nav">
                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link" href="{{ route('admin.category.index') }}">Manage
                                          Category</a>
                                  </li>
                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link" href="{{ route('admin.sub-category.index') }}">Manage
                                          Sub-category</a>
                                  </li>
                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link" href="{{ route('admin.child-category.index') }}">Manage
                                          Child-category</a>
                                  </li>
                              </ul>
                          </div>
                      ...
                      <li class="nav-item">
                          ...
                          <div class="collapse" id="sidebarSettings">
                              <ul class="nav sub-navbar-nav">
                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link" href="{{ route('admin.settings.index') }}">General
                                          Settings</a>
                                  </li>
                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link" href="{{ route('admin.momo-settings.index') }}">momo
                                          setting</a>
                                  </li>
                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link"
                                          href="{{ route('admin.geniuspay-settings.index') }}">geniuspay setting</a>
                                  </li>
                      ...
                      <li class="nav-item">
                          <a class="nav-link {{ request()->routeIs('admin.store.*') ? 'active' : '' }}"
                      ...
                      <li class="nav-item">
                          <a class="nav-link {{ request()->routeIs('admin.stock-report.dashboard') ? 'active' : '' }}"
                              href="{{ route('admin.stock-report.dashboard') }}">
                              <span class="nav-icon">
                                  <iconify-icon icon="solar:chart-bold-duotone"></iconify-icon>
                              </span>
                              <span class="nav-text">Dashboard stock</span>
                          </a>
                      </li>

                      <li class="nav-item">
                          <a class="nav-link {{ request()->routeIs('admin.stock-report.alerts') ? 'active' : '' }}"
                              href="{{ route('admin.stock-report.alerts') }}">
                              <span class="nav-icon">
                              ...
                              <span class="nav-text">
                                  ...
                                  @if($stockAlertCount > 0)
                                      <span class="badge bg-danger ms-1">{{ $stockAlertCount }}</span>
                                  @endif
                              </span>
                          </a>
                      </li>
                      ...
                      <li class="nav-item">
                          <a class="nav-link menu-arrow {{ request()->routeIs('admin.stock-entry.*','admin.stock-transfer.*','admin.stock-inventory.*') ? '' : '' }}"
                             href="#sidebarMouvements" data-bs-toggle="collapse" role="button"
                             aria-expanded="{{ request()->routeIs('admin.stock-entry.*','admin.stock-transfer.*','admin.stock-inventory.*') ? 'true' : 'false' }}"
                             aria-controls="sidebarMouvements">
                              <span class="nav-icon">
                                  <iconify-icon icon="solar:transfer-horizontal-bold-duotone"></iconify-icon>
                              </span>
                              <span class="nav-text">Mouvements stock</span>
                          </a>
                          <div class="collapse {{ request()->routeIs('admin.stock-entry.*','admin.stock-transfer.*','admin.stock-inventory.*') ? 'show' : '' }}" id="sidebarMouvements">
                              <ul class="nav sub-navbar-nav">
                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link {{ request()->routeIs('admin.stock-entry.*') ? 'active' : '' }}"
                                         href="{{ route('admin.stock-entry.index') }}">Entrées de stock</a>
                                  </li>
                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link {{ request()->routeIs('admin.stock-transfer.*') ? 'active' : '' }}"
                                         href="{{ route('admin.stock-transfer.index') }}">Transferts</a>
                                  </li>
                                  <li class="sub-nav-item">
                                      <a class="sub-nav-link {{ request()->routeIs('admin.stock-inventory.*') ? 'active' : '' }}"
                                         href="{{ route('admin.stock-inventory.index') }}">Inventaires</a>
                                  </li>
                              </ul>
                          </div>
                      </li>
                      ...
                      <li class="nav-item">
                          <a class="nav-link {{ request()->routeIs('admin.store-user.*') ? 'active' : '' }}"
                              href="{{ route('admin.store-user.index') }}">
                              <span class="nav-icon">
                                  <iconify-icon icon="solar:users-group-rounded-bold-duotone"></iconify-icon>
                              </span>
                              <span class="nav-text">Équipes boutiques</span>
                          </a>
                      </li>
                      <li class="nav-item">
