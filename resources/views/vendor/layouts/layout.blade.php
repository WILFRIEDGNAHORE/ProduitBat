...
<head>
     ...
     <!-- App favicon -->
     <link rel="shortcut icon" href="{{asset('vendo/images/favicon.ico')}}">

     <!-- Vendor css (Require in all Page) -->
     <link href="{{asset('vendo/css/vendor.min.css')}}" rel="stylesheet" type="text/css" />

     <!-- Icons css (Require in all Page) -->
     <link href="{{asset('vendo/css/icons.min.css')}}" rel="stylesheet" type="text/css" />

     <!-- App css (Require in all Page) -->
     <link href="{{asset('vendo/css/app.min.css')}}" rel="stylesheet" type="text/css" />
...
<body>
  ...
  {{-- select 2 js --}}
    ...
    <script>
     ...
     <script src="{{asset('vendo/js/vendor.js')}}"></script>
